                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="{{ url('/') }}" class="d-block auth-logo">
                                        <img src="{{ asset('dason/assets/images/logo-stikes-single.png') }}" alt="" height="50"> <span class="logo-txt"> </span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    ...
                                    @if (Route::has('password.request'))
                                        <div class="mt-2 text-center">
                                            <p class="text-muted mb-0">Lupa password ? <a href="{{ route('password.request') }}"
                                                    class="text-primary fw-semibold"> {{ __('Klik disini') }} </a> </p>
                                        </div>
                                    @endif
                                    </div>
                                </div>
                                <div class="mt-2 mt-md-2 text-center">
                                    <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> PSPIG UNTAN</p>
                                </div>
                            </div>
                        </div>
                    </div>
