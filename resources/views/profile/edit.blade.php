                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Edit Profil Saya</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                        <li class="breadcrumb-item"><a href="{{ route('profil.index') }}">Profil Saya</a></li>
                                        <li class="breadcrumb-item active">Edit Profil Saya</li>
                                    </ol>
                                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <form method="POST" action="{{ route('profil.update', encrypt($user->id)) }}" enctype="multipart/form-data">
                                            @method('PATCH')
                                            @csrf
                                            ...
                                            <div>
                                                ...
                                                <div class="mb-3">
                                                    <label for="example-text-input" class="form-label">Jabatan</label>
                                                    <input name="jabatan" class="form-control" type="text" value="{{ old('jabatan', $user->jabatan) }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-text-input" class="form-label">No HP</label>
                                                    <input name="phone_number" class="form-control" type="number" value="{{ old('phone_number', $user->phone_number) }}" required>
                                                </div>
