        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Data Surat Penting ({{ $surats->count() }})</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                        <li class="breadcrumb-item active">Data Surat Penting</li>
                                    </ol>
                                </div>
                    ...
                    @can('create-surat')
                        <a href="#" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#uploadModal"><i class="fas fa-plus"></i> Tambah Surat Penting</a>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="uploadModalLabel">Tambah Surat Penting</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>

                                    <form action="{{ route('surat-penting.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="kategori_berkas" value="Surat Penting">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        @can('delete-surat')
                                                            <form id="input"
                                                                action="{{ route('surat-penting.destroy', $surat->id) }}"
                                                                method="POST"
                                                                onsubmit="return confirm('Apakah anda yakin ingin menghapus surat penting ini?');">
                                                                @csrf
                                                                @method('DELETE')
