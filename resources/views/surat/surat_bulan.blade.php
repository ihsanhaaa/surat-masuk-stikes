...
@section('title')
    Surat STIKes | Surat Bulan {{ $bulan }}
@endsection
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Data Surat Bulan {{ $bulan }} ({{ $surats->count() }})</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="{{ route('home') }}">Dashboard</a></li>
                                        <li class="breadcrumb-item active">Data Surat Bulan {{ $bulan }} </li>
                                    </ol>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 text-center my-3">
                                    <a href="{{ route('home') }}" class="btn btn-primary"> <i class="fas fa-arrow-left"></i> Kembali</a>
                                </div>
