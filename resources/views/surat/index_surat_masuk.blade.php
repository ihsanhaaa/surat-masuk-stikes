        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Data Surat Masuk ({{ $surats->count() }})</h4>
                    ...
                    @can('create-surat')
                        <a href="#" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#uploadModal"><i class="fas fa-plus"></i> Tambah Surat Masuk</a>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="uploadModalLabel">Tambah Surat Masuk</h5>
                                    ...
                                    <form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="kategori_berkas" value="Surat Masuk">
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        @can('delete-surat')
                                                            <form id="input"
                                                                ...
                                                                method="POST"
                                                                onsubmit="return confirm('Apakah anda yakin ingin menghapus surat masuk ini?');">
                                                                @csrf
                                                                @method('DELETE')
