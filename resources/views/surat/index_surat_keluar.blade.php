        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Data Surat Keluar ({{ $surats->count() }})</h4>
                    ...
                    @can('create-surat')
                        <a href="#" class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#uploadModal"><i class="fas fa-plus"></i> Tambah Surat Keluar</a>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="uploadModalLabel">Tambah Surat Keluar</h5>
                                    ...
                                    <form action="{{ route('surat-keluar.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" name="kategori_berkas" value="Surat Keluar">
                                        ...
                                        @foreach ($surats as $key => $surat)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="d-flex">
                                                        <a href="#" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#showModal{{ $surat->id }}"><i class="fas fa-eye"></i> Detail</a>
                                                        ...
                                                        @can('edit-surat')
                                                            <a href="#" class="btn btn-warning btn-sm mx-1" data-bs-toggle="modal" data-bs-target="#editModal{{ $surat->id }}"><i class="fas fa-edit"></i> Edit</a>
                                                        ...
                                                        @can('delete-surat')
                                                            <form id="input"
                                                                ...
                                                                method="POST"
                                                                onsubmit="return confirm('Apakah anda yakin ingin menghapus surat keluar ini?');">
                                                                @csrf
                                                                @method('DELETE')
